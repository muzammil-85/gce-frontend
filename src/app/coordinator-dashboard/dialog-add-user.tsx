...
{/*             <p className="text-base">
            ...
            >
              ...
              <br />
              <br />
              ഗ്രീൻ ക്ലീൻ കേരള ഹരിതമത്സരങ്ങളിൽ പങ്കെടുക്കുവാൻ മുകളിൽ കൊടുത്ത ലിങ്കിൽ ക്ലിക്ക് ചെയ്ത് രജിസ്റ്റർ ചെയ്യുക 
              <br/>
              <br/>
               ഈ വർഷം നട്ടുവളർത്തുന്ന വൃക്ഷത്തൈകൾ പരിപാലിച്ചതിനുശേഷം  ഓരോ മൂന്നുമാസം കൂടുമ്പോഴും അതിന്റെ കൂടെ സെൽഫിയെടുത്ത്  ഈ വെബ്സൈറ്റിൽ അപ്‌ലോഡ് ചെയ്യുക.ഭാഗ്യശാലികൾക്ക് സമ്മാനങ്ങൾ.
              <br/>
              <br/>
             നിങ്ങളുടെ  ഹരിത പ്രവർത്തനങ്ങളുടെയും, കലാസൃഷ്ടികളുടെയും   വീഡിയോ തയ്യാറാക്കി സ്കൂൾ കോഡിനേറ്ററിൽ നിന്നും രജിസ്ട്രേഷൻ നമ്പർ വാങ്ങി 9645 9645 92 എന്ന നമ്പറിലേക്ക് അയച്ചു കൊടുക്കുക.
              <br/>
              <br/>
               അവ Green Clean kerala   എന്ന യൂട്യൂബ് ചാനലിൽ  പബ്ലിഷ് ചെയ്യുന്നതും  ഒരു വിഭാഗത്തിലും ഏറ്റവും മികച്ചതിന്  പുരസ്കാരങ്ങളും സമ്മാനങ്ങളും നൽകുന്നതുമാണ്.
              <br/>
              <br/>
